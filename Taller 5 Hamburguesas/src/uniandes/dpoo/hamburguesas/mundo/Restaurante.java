...
public class Restaurante
{
     ...
     */
    public void iniciarPedido( String nombreCliente, String direccionCliente, ArrayList<Producto> productos) throws YaHayUnPedidoEnCursoException
    {
        if( pedidoEnCurso != null )
            throw new YaHayUnPedidoEnCursoException( pedidoEnCurso.getNombreCliente( ), nombreCliente );

        pedidoEnCurso = new Pedido( nombreCliente, direccionCliente, productos );
    }
